	...
	<div class="clearfix">
		<div class="js-stools-container-bar">
			<label for="filter_search" class="element-invisible"
				aria-invalid="false"><?php echo Text::_('COM_JED_SEARCH_FILTER_SUBMIT'); ?></label>
				<div class="input-group mb-3">
					<?php echo $search_filter->input; ?>
					<div class="input-group-append">
						<button class="btn btn-outline-success hasTooltip" title=""
					data-original-title="<?php echo Text::_('COM_JED_SEARCH_FILTER_SUBMIT'); ?>">
						...
						<button type="button" class="btn btn-outline-primary hasTooltip js-stools-btn-clear" title=""
							data-original-title="<?php echo Text::_('COM_JED_SEARCH_FILTER_CLEAR'); ?>"
							onclick="jQuery(this).closest('form').find('input').val('');">
							<?php echo Text::_('COM_JED_SEARCH_FILTER_CLEAR'); ?>
						</button>
					</div>
				</div>
		</div>
